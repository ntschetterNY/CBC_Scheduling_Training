...
export const curriculum: Module[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "The heart of our audio system is the Allen & Heath SQ-6 digital mixing console. Our gear lives in three places:\n\n- IN THE SOUND BOOTH with you: the SQ-6, the wireless receivers (Shure SLXD4 for the pastors; Sennheiser EW 100 and XS Wireless 2 for the vocals), the antenna distribution system that feeds them, and the Crown XTi 2000 amp for the hallway.\n- IN THE SOUND RACK ROOM off the stage: the AR2412 stage box, the house amps (Crown CX404) and system processing (dbx DriveRack PA, Rane AD 22d delay), the Allen & Heath ME-U hub for the personal mixers, and the PD-420VS conditioned power.\n- ON THE STAGE: the ME-500 personal mixers that give musicians their own in-ear monitor mixes.\n\nTied together: the AR2412 stage box carries the stage inputs to the console over a single SLink cable, the console feeds the house (main speakers), the hallway, and the live stream, and the wireless handheld mics are color-coded (Pastor, Blue, Yellow, Orange, Green, White) so we can find a channel fast.\n\nUnlike an analog board, the SQ-6 is a digital console: it shows one channel's controls on a touchscreen at a time, and it remembers complete setups called Scenes — so every service can start from the same trusted baseline.\n\nThat baseline is a Scene called 'Singing R1'. When the system turns on it asks whether to recall the baseline — you select YES to load it. 'Singing R1' is never overwritten, so it's always there as a clean, known-good starting point for the next service. You'll do this hands-on in the Powering Up module.",
